...
public class OpenGLFrame implements GLEventListener, KeyListener {
	...
	public static void main(String[] args) {
		OpenGLFrame sudotris = new OpenGLFrame();
		sudotris.start();
	}
	...
	public OpenGLFrame() {
		...
		gridSize = 9;
		matrice = new Matrice(gridSize);

		matrice.setLine(0, new int[] { 1, 2, 3, 4, 5, 6, 7, 8, 9 });
		matrice.setLine(1, new int[] { 23, 1, 2, 3, 4, 5, 6, 7, 8 });
		matrice.setLine(2, new int[] { 3, 2, 1, 2, 3, 4, 5, 6, 7 });
		matrice.setLine(3, new int[] { 4, 3, 2, 1, 2, 3, 4, 5, 6 });
		matrice.setLine(4, new int[] { 5, 4, 3, 2, 1, 2, 3, 4, 5 });
		matrice.setLine(5, new int[] { 6, 5, 4, 3, 2, 1, 2, 3, 4 });
		matrice.setLine(6, new int[] { 7, 6, 5, 4, 3, 5, 1, 2, 3 });
		matrice.setLine(7, new int[] { 8, 7, 6, 5, 4, 3, 6, 1, 2 });
		matrice.setLine(8, new int[] { 9, 8, 7, 6, 5, 4, 3, 2, 1 });
	}
	...
	private void drawCore(GLAutoDrawable drawable) {
		...
		for (int cellX = 0; cellX < gridSize; cellX++) {
			for (int cellY = 0; cellY < gridSize; cellY++) {
				int cell = matrice.getCell(cellX, cellY);
